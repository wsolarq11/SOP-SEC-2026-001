...
| 一级目录 | 域名 | 内容 |
| --- | --- | --- |
| 00-总纲与索引 | GEN（总纲） | L1 方针 / 定位总纲、系统说明、REGISTRY 索引 |
...
| 06-GEN-通用 | GEN | 跨域基础规范、流程与角色定义 |

## 已分配编号
| 文档号 | 标题 | 层级 | 域名 | 版本 | 关联标准 | 负责人 | 状态 | 源文件 | 目标目录 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| SOP-GEN-2026-001 | 合规与标准定位 | L1 | GEN | v1.0 | ISO 9001 / 27001 / 20000 | 待定 | Draft | sops/SOP-GEN-2026-001-合规与标准定位.md | 00-总纲与索引 |
| SOP-GEN-2026-002 | 表格排版规范（北极星原则） | L2 | GEN | 1.0 | 通用（不绑定单一标准） | 段天俊 | Draft | sops/SOP-GEN-2026-002-表格排版规范.md | 06-GEN-通用 |
| SOP-SEC-2026-001 | 安防平台人员变动信息处理标准作业程序书 | L3 | SEC | 1.0 | ISO/IEC 27001（人力资源安全 / offboarding） | 段天俊 | Draft | sops/SOP-SEC-2026-001.md | 01-SEC-信息安全 |
